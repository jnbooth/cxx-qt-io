...
pub mod ffi {
    ...
    unsafe extern "C++" {
        #[rust_name = "cxx_qlist_clear_QHttp2Configuration"]
        fn qlistClear(list: &mut QList_QHttp2Configuration);
        #[rust_name = "cxx_qlist_contains_QHttp2Configuration"]
...
pub(crate) unsafe fn get_unchecked(
    ...
    ffi::get_unchecked_QHttp2Configuration(s, pos)
}
...
pub(crate) fn index_of(
    ...
    ffi::index_of_QHttp2Configuration(v, value)
}
