...
pub mod ffi {
    ...
    unsafe extern "C++" {
        #[rust_name = "cxx_qlist_clear_QDeadlineTimer"]
        fn qlistClear(list: &mut QList_QDeadlineTimer);
        #[rust_name = "cxx_qlist_contains_QDeadlineTimer"]
