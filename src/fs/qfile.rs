...
unsafe impl Upcast<QIODevice> for QFile {
    unsafe fn upcast_ptr(this: *const Self) -> *const QIODevice {
        ...
        unsafe { ffi::upcast_qfile_qiodevice(this) }
    }

    unsafe fn from_base_ptr(base: *const QIODevice) -> *const Self {
        // SAFETY: downcast_qobject
        unsafe { ffi::downcast_qiodevice_qfile(base) }
    }
}
...
unsafe impl Upcast<QObject> for QFile {
    unsafe fn upcast_ptr(this: *const Self) -> *const QObject {
        // SAFETY: static_upcast
        unsafe { ffi::upcast_qfile_qobject(this) }
    }

    unsafe fn from_base_ptr(base: *const QObject) -> *const Self {
        // SAFETY: qobject_cast
        unsafe { ffi::downcast_qobject_qfile(base) }
    }
}
