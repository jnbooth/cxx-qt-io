...
mod ffi {
    ...
    unsafe extern "C++" {
        ...
        /// Sets the host address to null and sets the protocol to `NetworkLayerProtocol::UnknownNetworkLayerProtocol`.
        fn clear(&mut self);
        ...
        ///
        /// Note that IPv6 unique local unicast addresses are considered global addresses (see `is_unique_local_unicast()`), as are IPv4 addresses reserved for local networks by RFC 1918.
        ///
